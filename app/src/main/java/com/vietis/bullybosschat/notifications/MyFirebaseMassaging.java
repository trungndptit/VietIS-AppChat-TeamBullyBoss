...
public class MyFirebaseMassaging extends FirebaseMessagingService {
    ...
    /*
    Là lớp kế thừa từ Service FirebaseMessagingService.
    Là cần thiết nếu muốn xử lý bắt cừ tin nhắn thông báo nào trên ứng dụng của bạn chạy dưới background.
     */
