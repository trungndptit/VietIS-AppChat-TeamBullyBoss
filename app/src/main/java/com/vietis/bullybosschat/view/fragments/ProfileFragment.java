...
import com.vietis.bullybosschat.view.entrance.LoginActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MyProfileFragmentBinding myProfileFragmentBinding = MyProfileFragmentBinding.inflate(inflater, container, false);
        View view = myProfileFragmentBinding.getRoot();

        ProfileActivityViewModel profileActivityViewModel = new ProfileActivityViewModel(true, false);
        myProfileFragmentBinding.setProfileviewmodel(profileActivityViewModel);
        myProfileFragmentBinding.getProfileviewmodel().getProfile(Actions.getInstance().getUser().getId());

        myProfileFragmentBinding.setFragmentevent(new com.vietis.bullybosschat.commands.Fragment() {
            @Override
